...
namespace Haver.Models
{
    public class Purchasing
    {
        ...
        public DateTime? ExpecDate { get; set; } // LaterAdd - Only if IsFollowUpReq True

        [Required(ErrorMessage = "Purchasing date is required.")]
        [Display(Name = "Date")]
        public DateOnly PurchasingDate { get; set; } = DateOnly.FromDateTime(DateTime.Now);
